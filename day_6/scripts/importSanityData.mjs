...
const client = createClient({
    projectId: process.env.NEXT_PUBLIC_SANITY_PROJECT_ID="laihzzfy",
    dataset: process.env.NEXT_PUBLIC_SANITY_DATASET="production",
    useCdn: false,
    token: process.env.SANITY_API_TOKEN="sk2FGVhhU1nTO0gBUfFHPzdq8quuQcy0K7N4CY4FAGYwcOYWyvZKHaslDd6CXVLJ9qL5mTMTJ0JaKyojVPFrbtnvcnThM6j7qjJgb7BbjZvTaq0h2X5kb7HHsK6jRyUb5VxAZ4GCgCWwQSzrlNPf9jpki8SZr8SC3x9lhEDwOMh9TFuktbIr",
